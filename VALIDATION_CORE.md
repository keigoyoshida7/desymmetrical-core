...
- `npm test`: **38 passing tests** (31 TypeScript / 7 JavaScript). Model and persistence, acrylic side-slope geometry and invalid shapes, entrance-facing rotation and older Core save compatibility, seventeen-channel scene transforms, arm tracking / ownership correction, four-source Max integration, motion replay and real loopback WebSocket-to-UDP routing.
